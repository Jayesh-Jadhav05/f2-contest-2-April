...
filters.addEventListener("click",() => {
    ...
    // let selectb = document.getElementById("select-box");

    const profession = document.getElementById("select-box");
    if(profession.value === "professions"){
        alert("Select The Professions")
    }


const userlist = document.getElementById("ollist");

let result = arrays.filter((e) => {
...
result.forEach((e, i) => {
  ...
  professions.innerText = "Profession : " + e.profession;
  age.innerText = "Age : " + e.age;
  li.appendChild(number);
  li.appendChild(name);
  li.appendChild(professions);
  li.appendChild(age);
